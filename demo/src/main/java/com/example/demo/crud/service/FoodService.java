...
public class FoodService {
    ...
    public List<Food> listAllByConcertOwnerID(Integer concertOwnerID) {
    ...
    public List<FoodDTO> getFoodByConcertOwnerId(int concertOwnerId) {
        return repo.getFoodByConcertOwnerId(concertOwnerId);
    }
}
