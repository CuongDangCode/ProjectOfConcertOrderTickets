    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
            .authorizeRequests(authorizeRequests -> authorizeRequests
                .requestMatchers("/home_Guest", "/login", "/register", "/saveUser", "/verify", "/forgotPassword", "/resetPassword/**", "/resetPassword",
                                 ...
                                 "/user/edit/change-password/save", "/user/edit/history","/checkEmail","/movie/create","yard/new").permitAll()
            ...
            .formLogin(formLogin -> formLogin
                .loginPage("/home_Guest") // Trang mặc định khi không đăng nhập
